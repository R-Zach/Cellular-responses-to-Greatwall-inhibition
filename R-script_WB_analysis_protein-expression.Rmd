...
```{r}
path_data <- ### WB_B55a-GWL-PP2C-ENSA_protein-levels.xlsx
...
ggsave(paste(path_results, "graph_expression.pdf", sep = ""), graph_expression,
       width = 55, height = 65 , units = "mm", device = cairo_pdf)
```
...
ggsave(paste(path_results, "graph_ED50.pdf", sep = ""), graph_ED50,
       width = 40, height = 15 , units = "mm", device = cairo_pdf)
```
