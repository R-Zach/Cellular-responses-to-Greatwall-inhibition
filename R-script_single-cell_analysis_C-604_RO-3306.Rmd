...
graph_cell_count_heatmap <- ggplot(data = data_graph, aes(x = x_axis, y = RO3306, fill = count_norm)) +
...
graph_synergy_heatmap <- ggplot(data = data_graph, aes(x = x_axis, y = RO3306, fill = S_HSA)) +
...
graph_cell_cycle_heatmap <- ggplot(data = data_graph, aes(x = x_axis, y = RO3306, fill = prop)) +
  geom_tile(colour = colour_pallette[1], linewidth = 0.25) +
